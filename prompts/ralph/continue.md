...
- Root agent owns Ralph orchestration. Subagents should return scoped results; do not ask
  subagents to update Ralph state, run Ultrawork, or decide final completion.
