...
export function markConditionalPromptPostSuccess(
	sessionId,
	source,
	env = process.env,
) {
...
export function clearConditionalPrompt(
	sessionId,
	source,
	reason,
	env = process.env,
	...
	appendEvent(
		sessionId,
		{ type: "conditional_prompt_cleared", source, reason },
		env,
	);
	return state;
}
