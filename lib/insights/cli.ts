import { collectInsightsMessage, generateMetricsOnlyReport, insightsPaths } from "./report.ts";
...
export function parseInsightsArgs(args, env = process.env) {
  const options = { env, force: false, limit: 500, facetLimit: 50, noLlm: true, json: false };
